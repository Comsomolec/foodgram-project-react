# Generated by Django 3.2.16 on 2023-07-07 20:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=7, unique=True, validators=[django.core.validators.RegexValidator('^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$', message='Неверно указана кодировка HEX.')], verbose_name='Цвет в HEX')),
